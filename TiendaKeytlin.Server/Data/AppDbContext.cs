...
namespace TiendaKeytlin.Server.Data
{
    public class AppDbContext : DbContext
    {
        ...
        public DbSet<AperturaCaja> Aperturas { get; set; }
        public DbSet<CierreCaja> Cierres { get; set; }
        ...
        {                                              
            ...
            // Insertar datos iniciales para EstadoPedidos
            modelBuilder.Entity<EstadoPedido>().HasData(
                 new EstadoPedido { Id = 1, Nombre = "Pendiente" },
                 new EstadoPedido { Id = 2, Nombre = "En proceso" },
                 new EstadoPedido { Id = 3, Nombre = "Completado" },
